...
const Verification = () => {
  return (
    <section className="flex items-center justify-center h-[100vh] px-[1.5em]">
      <div className="max-[538px]:w-full  max-[538px]:px-[1.5em] w-max bg-white rounded-[1.5em] px-[4em] py-[3em] text-center">
